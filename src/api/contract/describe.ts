...
import type {MountInfo} from '@/domain/capabilities/Capabilities';
import type {NameRules} from '@/domain/naming/NameRules';

export type {MountInfo};

/** Версия контракта, которую реализует этот клиент. */
export const CONTRACT_NAME = 'bescms-fs';
